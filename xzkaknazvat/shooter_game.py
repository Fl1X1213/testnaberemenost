...
hero2 = hero2 = Player('rocket.png', 300, 400, 5, 80, 100)
is_duo = True
...
txt_lose = font2.render('Uou lose', True, (255, 0, 0))
...
while game:
    ...
    if screen == 'main':
        text_lost = font1.render(f'Пропущено: {lose}', True, (255, 255, 255))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_SPACE and is_duo:
